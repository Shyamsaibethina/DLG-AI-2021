...
# I put "#!" surrounding the code that I added that allowed it to record the gif.
...
def prepro(I):
  ...
  I = I[35:195] # crop
  I = I[::2,::2,0] # downsample by factor of 2 (halves the resolution of the image)
...
#!
frames = []
STEPS = 300 #make this bigger to record longer gif (idk how to have it start recording the gif in the middle of training
# ex. record the 1st episode, 3000th episode, and 6000th episode)
...
#!
  ...
  if done: # an episode finished
    ...
    print('running_reward is', running_reward)
...
#!
save_frames_as_gif(frames, filename = 'karpathyModelBeginning.gif')
#!